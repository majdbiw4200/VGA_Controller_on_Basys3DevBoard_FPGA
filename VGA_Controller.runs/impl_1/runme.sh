...
HD_PWD='D:/xilinix vivado/projects/VGA_Controller/VGA_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Test_Patterns_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Test_Patterns_Top.tcl -notrace
