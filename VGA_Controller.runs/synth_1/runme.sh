...
HD_PWD='D:/xilinix vivado/projects/VGA_Controller/VGA_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Test_Patterns_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Test_Patterns_Top.tcl
